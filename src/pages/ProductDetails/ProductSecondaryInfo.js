      ...
      <div className='border-2 border-t-0 rounded-bl-md rounded-br-md py-3 px-4 capitalize-first flex gap-5 justify-between'>
        {product?.description.length > 50 ? (
          ...
          <p className='flex-1 text-gray-600'>
            ...
            Harum delectus consequuntur aperiam doloribus aliquid in
            maiores inventore facilis, consectetur officia ullam
            dolorem aliquam velit ipsa fuga omnis suscipit sequi.
            Voluptatum!
          </p>
        )}
