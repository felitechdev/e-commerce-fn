          ...
          <div className='flex flex-col gap-2'>
            {isLoading && (
              <span className='text-xs font-bold leadin-5 text-gray-700'>
                Follow instructions on your phone to
                proceed.
              </span>
            )}
...
const Cart = () => {
  ...
  const [ispaymentsucces, setIspaymentsucces] =
    useState(false);
  ...
  const [deliveryPreference, setDeliveryPreference] =
    useState('');
  const [prevdeliveryprice, setPrevdeliveryprice] =
    useState(0);
  ...
  let provinceselectoption = Provinces()?.map(
    (province) => {
      return {
        value: province,
        label: province,
            ...
            >
              ...
              <div className='max-w-[500px] p-4 py-8 bg-white flex gap-4 flex-col items-center rounded-md shadow-lg'>
                ...
                <p className='text-sm text-center px-10 -mt-2'>
                  ...
                  purpose - fill it with books, electronics,
