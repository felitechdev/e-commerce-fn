...
//     <>
//       <li
//         className={`!relative border-[blue] border ${
//           props.ismobileview
...
//           )
//         ) : (
//           <div className=" flex justify-center  bg-[red]  text-center">
...
//       {displayDropdown && (
//         <div
//           className="fixed top-[50px] border-[red] !text-right md:top-[75px] right-2 w-40 rounded-md py-2 px-2 border-2 bg-[#1D6F2B]"
//           ref={dropDownRef}
//         >
